package com.example.lab6_ph35419.ui.screens
...
import com.example.lab6_ph35419.model.entities.Seat
import com.example.lab6_ph35419.model.entities.SeatStatus
import com.example.lab6_ph35419.ui.components.SeatComposable
...
fun createTheaterSeating(
    ...
    for (rowIndex in 0 until totalRows) {
        for (seatIndex in 1..totalSeatsPerRow) {
            ...
            val status = when {
                isAisleRow || isAisleColumn -> SeatStatus.AILSE
